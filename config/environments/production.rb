Rails.application.configure do
  ...
  config.action_mailer.smtp_settings = {
    ...
    user_name: Rails.application.credentials.gmail => ENV["GMAIL_USERNAME"],
    #gmail２段階認証回避のためにアプリケーションでの利用パスワードを取得、必ずcredentials.yml.endに設定を！！
    password: Rails.application.credentials.gmail => ENV["GMAIL_PASSWORD"],
    #パスワードをBase64でエンコード
  ...
  # config.active_job.queue_name_prefix = "iSports_#{Rails.env}"
